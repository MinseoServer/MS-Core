...
fun Plugin.coroutine(initialContext: SynchronizationContext = SYNC,
                     co: suspend BukkitSchedulerController.() -> Unit): CoroutineTask {
    return server.scheduler.coroutine(this, initialContext, co)
}

fun BukkitScheduler.coroutine(plugin: Plugin, initialContext: SynchronizationContext = SYNC,
                              co: suspend BukkitSchedulerController.() -> Unit): CoroutineTask {
